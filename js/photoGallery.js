;(function($){
	var PhotoGallery = function(){
		...
		this.picConUrl = $('a.photoGallery-picConUrl');
	...
	PhotoGallery.prototype = {
		...
		changePic : function(curSrc){
			this.picConUrl.attr("href",curSrc);
		...
		renderDOM : function(){
			...
			this.picWrapper.html('<span class="photoGallery-close-btn"></span>'+
								 ...
								 '</div>'+
								 '<a class="photoGallery-picConUrl" target="_blank" href=""><img class="photoGallery-picCon" src="">'+
								 '<div class="photoGallery-picDesc"></a>'+
								 '</div>');
